...
f=open('train_intensity_casme.json','r')
...
class IEMR(Sequence):
    def __init__(self):
        ...
        print(len(self.intensity_arr[0]))
        print(len(self.intensity_arr[0][0]))
        self.data_len = 4845
        self.temp=[]
        '''self.switch = {
        ...
        self.switch = {
            ...
            '11':self.__scaling__,#None
            '12':self.__None__,#None
            }
        self.param = {
            '1':0.25,#Scaling0.25
            '2':0.5,#Scaling0.5
