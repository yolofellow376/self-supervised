...
class IEMR(Sequence):
    ...
    def __getitem__(self, index):
       ...
       #print("signal_label:",signal_label)
        ...
        c_labels=[]
        c_labels.append(index_label)
        c_labels.append(signal_label)
        c_labels=tf.convert_to_tensor(c_labels)
        c_labels = tf.expand_dims(c_labels,axis=0)
        #print(tf.shape(intensity_arr), tf.shape(c_labels))
        #print(c_labels)
        return intensity_arr, c_labels #[index_label, signal_label]
